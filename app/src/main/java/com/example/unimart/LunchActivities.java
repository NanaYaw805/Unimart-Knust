...
public class LunchActivities extends AppCompatActivity implements BreakfastOthersAdapter.OnItemClickListener {
    RecyclerView recyclerView;
    SearchView searchView;
    BreakfastOthersAdapter breakfastOthersAdapter;
    ArrayList<HallModel> breakItems;

    String[] lunch_food_names = new String[]
            {
    ...
    String[] lunch_vendor_ids = new String[]
            {
    ...
    String[] lunch_food_times = new String[]
            {
                    "12:30pm-4:30pm", "12:30pm-4:30pm", "12:30pm-4:30pm",
                    "12:30pm-4:30pm", "12:30pm-4:30pm", "12:30pm-4:30pm",
                    "12:30pm-4:30pm", "12:30pm-4:30pm", "12:30pm-4:30pm",
                    "12:30pm-4:30pm", "12:30pm-4:30pm", "12:30pm-4:30pm",
                    "12:30pm-4:30pm", "12:30pm-4:30pm", "12:30pm-4:30pm",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.lunch_recycler);
        searchView = findViewById(R.id.search_view_lunch);

        breakItems = new ArrayList<>();



        breakfastOthersAdapter = new BreakfastOthersAdapter(LunchActivities.this, breakItems);
        breakfastOthersAdapter.setOnItemClickListener(this);
        recyclerView.setLayoutManager(new LinearLayoutManager(LunchActivities.this, LinearLayoutManager.VERTICAL, false));
        recyclerView.setHasFixedSize(true);
        recyclerView.setAdapter(breakfastOthersAdapter);
        for (int j = 0; j < lunch_food_names.length; j++) {
            HallModel categoryModel = new HallModel(lunch_food_names[j], location[j], lunch_food_times[j], lunch_images[j], lunch_vendor_ids[j]);
    ...
    private boolean filterList(String text) {
        ...
        if (breakfast_new_filter.isEmpty()) {
            Toast.makeText(LunchActivities.this, "Sorry! cannot find the food here", Toast.LENGTH_SHORT).show();
        } else {
    ...
    public void onItemClick(HallModel hallModel) {
        Intent intent = new Intent(LunchActivities.this, ShowDetailsActivity.class);
